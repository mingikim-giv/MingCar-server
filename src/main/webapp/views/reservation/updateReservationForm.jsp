...
<body>
	<section id="root">
		...
		<div id="reservation-info">
			<form action="/reservationUpdateFormAction" id="find-car-by-time">
				<span>대여일</span><input type="date" name="resevDate" id="resevDate" value="${resevDate}"> 
				<select name="resevTime" id="resevTime">
